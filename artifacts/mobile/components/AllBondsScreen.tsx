...
import {
  View, Text, TouchableOpacity, ScrollView, TextInput, Modal, SafeAreaView, FlatList,
} from "react-native";
...
interface BondItemProps {
  b: typeof ALL_BONDS[number];
}

function BondItem({ b }: BondItemProps) {
  return (
...
export default function AllBondsScreen({ visible, onClose }: Props) {
      ...
      <View style={{ flex: 1, backgroundColor: C.background }}>
        <SafeAreaView style={{ flex: 1 }}>
          ...
          <View style={{ paddingHorizontal: S.xl, paddingTop: S.lg }}>
            <TouchableOpacity onPress={onClose} activeOpacity={0.7} style={{ marginBottom: S.xl }}>
